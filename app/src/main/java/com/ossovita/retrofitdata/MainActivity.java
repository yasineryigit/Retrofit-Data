...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPhotosByAlbumId();//resimleri çekip listeyi dolduracak
        //photos.add(new Photos(12,15,"New Photo","https://via.placeholder.com/150/25474f"));
    ...
    private void getPhotosByAlbumId() {
        ...
        Call<List<Photos>> call = photosApi.getPhotosByAlbumId(15);//gelen verileri Photos türünde obje listesine dönüştürecek.
